...
9. Read BULLETIN.md (at the root of this repo) — cross-home bulletin board (announcements, action items, discussions from agents across homes). Check for action items addressed to you.
